...
const Footer = () => {
  return (
    <div className="footer-content bg-green grey">
      <div className="footer-1">
        <h6>EXTERMINATORS PRO</h6>
        <p>© 2022 exterminatorspros.com — All Rights Reserved</p>
      </div>
      <div className="footer-2">
        <p>
          Exterminators Pros is a free referral service that helps users connect
          ...
          center. All contractors are independent and Exterminators Pros does
